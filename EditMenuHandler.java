...
public class EditMenuHandler implements ActionListener{
	   ...
	   public void actionPerformed(ActionEvent event) {
	      ...
	      if (menuName.equals("Add Word")) //if user clicks add word...
	    	 //JPane pops up asking user to enter a word
	         input= JOptionPane.showInputDialog(null,"enter a word to add to the words already read from the file:");
	      	 //calls WordGUI constructor which will add the word to the GUI
	      	 new WordGUI(input, placeHolder);
	   } 
